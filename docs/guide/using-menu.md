...
Return of `orcsis\admin\components\MenuHelper::getAssignedMenu()` has default format like:
...
return format of `orcsis\admin\components\MenuHelper::getAssignedMenu()` by provide a callback to this methode.
...
Using Sparated Menu
-------------------
Second parameter of `orcsis\admin\components\MenuHelper::getAssignedMenu()` used to get menu on it's own hierarchy.
